...
\newfontfamily\descriptionfont[Path = fonts/raleway/]{Raleway-Regular}
\newfontfamily\datefont[Path = fonts/raleway/]{Raleway-Regular}
\newfontfamily\locationfont[Path = fonts/raleway/]{Raleway-Regular}
...
% Less important
\newcommand{\datesize}{\fontsize{8pt}{9.6pt}\selectfont}
\newcommand{\locationsize}{\fontsize{8pt}{9.6pt}\selectfont}
